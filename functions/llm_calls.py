...
def call_llm_model(
    ...
    Parameters:
        ...
        max_output_tokens (int, optional): Specifically for Gemini API - controls the maximum 
    ...
    # Add Gemini-specific parameter for max output tokens if provided
    if max_output_tokens is not None and "gemini" in model.lower():
